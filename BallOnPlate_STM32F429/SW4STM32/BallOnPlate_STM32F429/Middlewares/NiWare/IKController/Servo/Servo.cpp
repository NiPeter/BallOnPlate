...
Servo::Servo(const Servo& servo) {
	this->Channel = servo.Channel;
	this->Frequency = servo.Frequency;
	this->Resolution = servo.Resolution;
	this->hTIM = servo.hTIM;
	this->ms_max = servo.ms_max;
	this->ms_min = servo.ms_min;
}
